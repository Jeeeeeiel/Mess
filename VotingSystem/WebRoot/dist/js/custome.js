        ...
        success:function(data){
            ...
            $.each(json.VoteSubjects, function(key, value){
                $("#list-group").append('<li class="list-group-item">'+
                    ...
                    '<span style="margin:10px"><input type="radio" name="iCheck'+(key+1)+'" value="1"> <label style="left-margin:20px;font-size:150%">A</label></span>'+
                    '<span style="margin:10px"><input type="radio" name="iCheck'+(key+1)+'" value="2"> <label style="left-margin:20px;font-size:150%">B</label></span>'+
                    '<span style="margin:10px"><input type="radio" name="iCheck'+(key+1)+'" value="3"> <label style="left-margin:20px;font-size:150%">C</label></span>'+
                    '</li>');
            }); 
            if(json.VoteSubjects.length>0){
                ...
                $("#list-group").after('<input id="submit" class="btn btn-primary" type="button" style="width:100%;font-size:220%;font-weight:bold;font-family:宋体" value="提 交" onclick="submit()"/>');
                $('input').iCheck({
